...
public class CronExpressionDescriptorDETest {
  ...
  public void testEvery45Seconds() throws Exception {
    ...
    Assert.assertEquals("Alle 45 Sekunden",
            CronExpressionDescriptor.getDescription("*/45 * * * * *", Options.twentyFourHour(), GERMAN));
  }

  @Test
  public void testMinuteSpan() throws Exception {
    Assert.assertEquals("Jede Minute zwischen 11:00 AM und 11:10 AM",
  ...
  public void testTwiceAWeek() throws Exception {
    Assert.assertEquals("Um 9:46 AM, nur am Montag und Dienstag",
        CronExpressionDescriptor.getDescription("46 9 * * 1,2", GERMAN));
    Assert.assertEquals("Um 9:46 AM, nur am Sonntag und Samstag",
        CronExpressionDescriptor.getDescription("46 9 * * 0,6", GERMAN));
    Assert.assertEquals("Um 9:46 AM, nur am Samstag und Sonntag",
  ...
  public void testDayOfWeekRange() throws Exception {
    Assert.assertEquals("Alle 5 Minuten, um 3:00 PM, Montag bis Freitag",
        CronExpressionDescriptor.getDescription("*/5 15 * * MON-FRI", GERMAN));
    Assert.assertEquals("Alle 5 Minuten, um 3:00 PM, Sonntag bis Samstag",
  ...
  public void testTimeOfDayWithSeconds() throws Exception {
    Assert.assertEquals("Um 2:02:30 PM",
  ...
  public void testSecondMinutesHoursIntervals() throws Exception {
    Assert.assertEquals(
        "Sekunden 5 bis 10 nach der vollen Minute, Minuten 30 bis 35 nach der vollen Stunde, zwischen 10:00 AM und 12:00 PM",
  ...
  public void testMinutesPastTheHourRange() throws Exception {
    Assert.assertEquals(
        "Um 30 Minuten nach der vollen Stunde, zwischen 10:00 AM und 1:00 PM, nur am Mittwoch und Freitag",
  ...
  public void testBetweenWithInterval() throws Exception {
    Assert.assertEquals(
        "Alle 3 Minuten, Minuten 02 bis 59 nach der vollen Stunde, um 1:00 AM, 9:00 AM und 10:00 PM, zwischen Tag 11 und 26 des Monats, Januar bis Juni",
  ...
  public void testRecurringFirstOfMonth() throws Exception {
    Assert.assertEquals("Um 6:00 AM",
  ...
  public void testEveryXMinutePastTheHourWithInterval() throws Exception {
    Assert.assertEquals(
        "Alle 2 Minuten, Minuten 00 bis 30 nach der vollen Stunde, um 5:00 PM, Montag bis Freitag",
  ...
  public void testYearRange2() throws Exception {
    Assert.assertEquals("Um 12:23 PM, Januar bis Februar, 2013 bis 2014",
        CronExpressionDescriptor.getDescription("23 12 * JAN-FEB * 2013-2014", GERMAN));
  }

  @Test
  public void testYearRange3() throws Exception {
    Assert.assertEquals("Um 12:23 PM, Januar bis März, 2013 bis 2015",
  ...
  public void testIssue26() throws Exception {
    Assert.assertEquals("Um 05 und 10 Minuten nach der vollen Stunde",
        CronExpressionDescriptor.getDescription("5,10 * * * *", GERMAN));
    Assert.assertEquals("Um 05 und 10 Minuten nach der vollen Stunde, um 12:00 AM",
    ...
    Assert.assertEquals("Um 05 und 10 Minuten nach der vollen Stunde, am 2. des Monats",
        CronExpressionDescriptor.getDescription("5,10 * 2 * *", GERMAN));
      Assert.assertEquals("Um 05 und 10 Minuten nach der vollen Stunde, um 12:00 AM, am 2. des Monats",
              CronExpressionDescriptor.getDescription("5,10 0 2 * *", GERMAN));
    Assert.assertEquals("Alle 10 Minuten, am 2. des Monats",
        CronExpressionDescriptor.getDescription("5/10 * 2 * *", GERMAN));
      Assert.assertEquals("Alle 10 Minuten, um 12:00 AM, am 2. des Monats",
              CronExpressionDescriptor.getDescription("5/10 0 2 * *", GERMAN));
    Assert.assertEquals("Um 5 und 6 Sekunden nach der vollen Minute",
        CronExpressionDescriptor.getDescription("5,6 * * * * *", GERMAN));
    Assert.assertEquals("Um 5 und 6 Sekunden nach der vollen Minute, um 12:00 AM",
              CronExpressionDescriptor.getDescription("5,6 0 0 * * *", GERMAN));
    Assert.assertEquals("Um 5 und 6 Sekunden nach der vollen Minute, um 1:00 AM",
    ...
    Assert.assertEquals("Um 5 und 6 Sekunden nach der vollen Minute, am 2. des Monats",
        CronExpressionDescriptor.getDescription("5,6 0 * 2 * *", GERMAN));
      Assert.assertEquals("Um 5 und 6 Sekunden nach der vollen Minute, um 12:00 AM, am 2. des Monats",
