...
public class CronExpressionDescriptorNLTest {
    ...
    public void testMinuteSpan() throws Exception {
        Assert.assertEquals("Elke minuut tussen 11:00 en 11:10", CronExpressionDescriptor.getDescription("0-10 11 * * *", DUTCH));
    }
    ...
    public void testDailyAtTime() throws Exception {
        Assert.assertEquals("Om 11:30", CronExpressionDescriptor.getDescription("30 11 * * *", DUTCH));
    }

    @Test
    public void testTimeOfDayCertainDaysOfWeek() throws Exception {
        Assert.assertEquals("Om 23:00, van maandag tot vrijdag", CronExpressionDescriptor.getDescription("0 23 ? * MON-FRI", DUTCH));
        Assert.assertEquals("Om 11:30, van maandag tot vrijdag", CronExpressionDescriptor.getDescription("30 11 * * 1-5", DUTCH));
    }
    ...
    public void testTwoTimesEachAfternoon() throws Exception {
        Assert.assertEquals("Om 14:30 en 16:30", CronExpressionDescriptor.getDescription("30 14,16 * * *", DUTCH));
    }

    @Test
    public void testThreeTimesDaily() throws Exception {
        Assert.assertEquals("Om 6:30, 14:30 en 16:30", CronExpressionDescriptor.getDescription("30 6,14,16 * * *", DUTCH));
    }

    @Test
    public void testOnceAWeek() throws Exception {
        Assert.assertEquals("Om 9:46, alleen op zondag", CronExpressionDescriptor.getDescription("46 9 * * 0", DUTCH));
        Assert.assertEquals("Om 9:46, alleen op zondag", CronExpressionDescriptor.getDescription("46 9 * * 7", DUTCH));
        Assert.assertEquals("Om 9:46, alleen op maandag", CronExpressionDescriptor.getDescription("46 9 * * 1", DUTCH));
        Assert.assertEquals("Om 9:46, alleen op zaterdag", CronExpressionDescriptor.getDescription("46 9 * * 6", DUTCH));
    }
    ...
    public void testOnceAWeekNonZeroBased() throws Exception {
        ...
        Assert.assertEquals("Om 9:46, alleen op zondag", CronExpressionDescriptor.getDescription("46 9 * * 1", options, DUTCH));
        Assert.assertEquals("Om 9:46, alleen op maandag", CronExpressionDescriptor.getDescription("46 9 * * 2", options, DUTCH));
        Assert.assertEquals("Om 9:46, alleen op zaterdag", CronExpressionDescriptor.getDescription("46 9 * * 7", options, DUTCH));
    }

    @Test
    public void testTwiceAWeek() throws Exception {
        Assert.assertEquals("Om 9:46, alleen op maandag en dinsdag", CronExpressionDescriptor.getDescription("46 9 * * 1,2", DUTCH));
        Assert.assertEquals("Om 9:46, alleen op zondag en zaterdag", CronExpressionDescriptor.getDescription("46 9 * * 0,6", DUTCH));
        Assert.assertEquals("Om 9:46, alleen op zaterdag en zondag", CronExpressionDescriptor.getDescription("46 9 * * 6,7", DUTCH));
    }
    ...
    public void testTwiceAWeekNonZeroBased() throws Exception {
        Options options = new Options();
        options.setZeroBasedDayOfWeek(false);
        Assert.assertEquals("Om 9:46, alleen op zondag en maandag", CronExpressionDescriptor.getDescription("46 9 * * 1,2", options, DUTCH));
        Assert.assertEquals("Om 9:46, alleen op vrijdag en zaterdag", CronExpressionDescriptor.getDescription("46 9 * * 6,7", options, DUTCH));
    }

    @Test
    public void testDayOfMonth() throws Exception {
        Assert.assertEquals("Om 12:23, op de 15e dag van de maand", CronExpressionDescriptor.getDescription("23 12 15 * *", DUTCH));
    }

    @Test
    public void testMonthName() throws Exception {
        Assert.assertEquals("Om 12:23, alleen in januari", CronExpressionDescriptor.getDescription("23 12 * JAN *", DUTCH));
    }
    ...
    public void testMonthNameRange2() throws Exception {
        Assert.assertEquals("Om 12:23, van januari tot februari", CronExpressionDescriptor.getDescription("23 12 * JAN-FEB *", DUTCH));
    }

    @Test
    public void testMonthNameRange3() throws Exception {
        Assert.assertEquals("Om 12:23, van januari tot maart", CronExpressionDescriptor.getDescription("23 12 * JAN-MAR *", DUTCH));
    }

    @Test
    public void testDayOfWeekName() throws Exception {
        Assert.assertEquals("Om 12:23, alleen op zondag", CronExpressionDescriptor.getDescription("23 12 * * SUN", DUTCH));
    }

    @Test
    public void testDayOfWeekRange() throws Exception {
        Assert.assertEquals("Elke 5 minuten, om 15:00, van maandag tot vrijdag", CronExpressionDescriptor.getDescription("*/5 15 * * MON-FRI", DUTCH));
        Assert.assertEquals("Elke 5 minuten, om 15:00, van zondag tot zaterdag", CronExpressionDescriptor.getDescription("*/5 15 * * 0-6", DUTCH));
        Assert.assertEquals("Elke 5 minuten, om 15:00, van zaterdag tot zondag", CronExpressionDescriptor.getDescription("*/5 15 * * 6-7", DUTCH));
    }
    ...
    public void testTimeOfDayWithSeconds() throws Exception {
        Assert.assertEquals("Om 14:02:30", CronExpressionDescriptor.getDescription("30 02 14 * * *", DUTCH));
    }
    ...
    public void testSecondMinutesHoursIntervals() throws Exception {
        Assert.assertEquals("Van 5 tot 10 seconden na de minuut, van 30 tot 35 minuten na het uur, tussen 10:00 en 12:00",
    ...
    public void testMinutesPastTheHourRange() throws Exception {
        Assert.assertEquals("Om 30 minuten na het uur, tussen 10:00 en 13:00, alleen op woensdag en vrijdag",
    ...
    public void testBetweenWithInterval() throws Exception {
        Assert.assertEquals("Elke 3 minuten, van 02 tot 59 minuten na het uur, om 1:00, 9:00 en 22:00, tussen dag 11 en 26 van de maand, van januari tot juni",
    ...
    public void testRecurringFirstOfMonth() throws Exception {
        Assert.assertEquals("Om 6:00", CronExpressionDescriptor.getDescription("0 0 6 1/1 * ?", DUTCH));
    }
    ...
    public void testEveryXMinutePastTheHourWithInterval() throws Exception {
        Assert.assertEquals("Elke 2 minuten, van 00 tot 30 minuten na het uur, om 17:00, van maandag tot vrijdag", CronExpressionDescriptor.getDescription("0 0-30/2 17 ? * MON-FRI", DUTCH));
    }
    ...
    public void testYearRange2() throws Exception {
        Assert.assertEquals("Om 12:23, van januari tot februari, van 2013 tot 2014", CronExpressionDescriptor.getDescription("23 12 * JAN-FEB * 2013-2014", DUTCH));
    }

    @Test
    public void testYearRange3() throws Exception {
        Assert.assertEquals("Om 12:23, van januari tot maart, van 2013 tot 2015", CronExpressionDescriptor.getDescription("23 12 * JAN-MAR * 2013-2015", DUTCH));
    }
    ...
    public void testIssue26() throws Exception {
        ...
        Assert.assertEquals("5 en 6 seconden na de minuut, om 1:00", CronExpressionDescriptor.getDescription("5,6 0 1 * * *", DUTCH));
